...
export default function ProductExamples() {
  ...
  const [newsletterModalOpen, setNewsletterModalOpen] = useState<boolean>(
    false
  );
  const [announcementModalOpen, setAnnouncementModalOpen] = useState<boolean>(
    false
  );
  const [integrationModalOpen, setIntegrationModalOpen] = useState<boolean>(
    false
  );
