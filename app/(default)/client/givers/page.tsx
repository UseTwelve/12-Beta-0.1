...
import { fetchRecords, addRecord, updateRecord, deleteRecord, uploadRecord } from '@/lib/hooks/useGoogleSheet';
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
      ...
      <div className="sm:flex sm:justify-between sm:items-center mb-5">
        ...
        <div className="mb-4 sm:mb-0">
          <h1 className="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Givers</h1>
        </div>
        {/* Right: Actions */}
